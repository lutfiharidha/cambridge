...
<div class="uk-container uk-container-medium uk-card uk-card-secondary" uk-scrollspy="cls: uk-animation-fade; repeat: true">
   <form class="uk-padding " action="{{ route('storearticle') }}"  enctype="multipart/form-data" method="post">
      <fieldset class=" uk-margin-top uk-fieldset">
         ...
         Article
         <div class="uk-margin">
            <textarea class="uk-textarea ckeditor" id="ckedtor" name="article" rows="5"></textarea>
         </div>
         Writer
         <div class="uk-margin">

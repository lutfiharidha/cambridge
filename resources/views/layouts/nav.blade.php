...
<head>
    ...
    <title>Cambridge School Lhokseumawe</title>
    <!-- UIkit CSS -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.19/css/uikit.min.css" />
      <link rel="stylesheet" href="{{ url('css/app.css') }}" />
<style type="text/css">
  ::-webkit-scrollbar{width: 7px;}::-webkit-scrollbar-track{box-shadow: inset 0 0 0 grey;border-radius: 3px;}::-webkit-scrollbar-thumb{background: darkblue;border-radius: 10px;}::-webkit-scrollbar-thumb:hover{background: darkblue;}.image-cropper {width: 150px;height: 150px;position: relative;overflow: hidden;border-radius: 50%;}.testi{display: inline;margin: 0 auto;width: 100%;height: auto;}
        ...
        <div class="uk-offcanvas-bar">
          ...
          <hr>
            <ul class="uk-nav uk-nav-default">
               ...
               <li class="uk-active uk-margin"><a href="#pricing" uk-scroll>Pricing</a></li>
...
<div class="uk-background-fixed uk-visible@m uk-background-cover" uk-height-viewport="offset-bottom: false" style="background-image: url(http://www.kardiniachurch.com/images/pages/21/courses-top-background.jpg);">
               <nav class="uk-navbar-transparent uk-container uk-container-medium" uk-navbar>
                  ...
                  <div class="uk-navbar-right">
                     <div>
                        <ul class="uk-navbar-nav ">
                           <li class="uk-active">
                              <a class="uk-button uk-button-text" href="{{ route('beranda') }}" uk-scroll>Home</a>
                           </li>
                           <li class="uk-active">
                           ...
                           <li>
                              <a href="#pricing" uk-scroll> <button class="uk-button uk-button-secondary">Pricing</button></a>
                           </li>
                           <li>
                            @guest
